            ...
            <div className="flex ml-20 mt-20">
                ...
                <div className="text-xl ml-20 space-y-8 bg-slate-400 shadow-2xl rounded-lg border-2 p-5">
                    ...
                    {/* { currAddress !== data.owner || currAddress !== data.seller ?
                       <h4>Token transmitted from {data.owner} to {data.seller}</h4>
                             :
                    <>
                       <h4>Token transmitted from {data.owner} to {data.seller}</h4> <br/>
                       <h4>Token transmitted from {data.seller} to {data.currAddress}</h4>
